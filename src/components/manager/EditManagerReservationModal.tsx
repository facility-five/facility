...
interface EditManagerReservationModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess: () => void;
...
export const EditManagerReservationModal = ({
  isOpen,
  onClose,
  onSuccess,
  reservation,
}: EditManagerReservationModalProps) => {
  ...
  useEffect(() => {
    if (reservation && isOpen) {
      ...
      // Set selected area for fee display
      if (reservation.common_areas) {
        setSelectedArea(reservation.common_areas);
      }
    }
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Edite os dados da reserva {reservation.code}. Modifique os campos necessários.
          </DialogDescription>
        </DialogHeader>
