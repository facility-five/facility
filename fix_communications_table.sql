...
-- 3. Verificar se a coluna condo_id existe (pode ser condominium_id)
DO $$
BEGIN
...
-- 6. Criar políticas RLS atualizadas
...
-- 7. Verificação final
SELECT 'Configuração concluída - Tabela communications pronta!' as status;