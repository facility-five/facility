-- Recriar a função com SECURITY DEFINER para contornar RLS
...
BEGIN
  ...
  LEFT JOIN profiles creator ON creator.id = a.user_id
...
GRANT EXECUTE ON FUNCTION get_administrators_with_details() TO authenticated;

-- Comentário explicativo
COMMENT ON FUNCTION get_administrators_with_details() IS 'Retorna todas as administradoras com contagem de condomínios, dados do responsável (gestor) e dados de quem cadastrou. Usa SECURITY DEFINER para contornar RLS.';
